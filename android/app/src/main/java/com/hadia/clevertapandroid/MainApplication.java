...
import com.hadia.clevertapandroid.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.hadia.clevertapandroid.ReactNativeFlipper");
        aClass
